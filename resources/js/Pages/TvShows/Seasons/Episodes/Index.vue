                ...
                <section class="container mx-auto p-6 font-mono">
                    ...
                    <div class="w-full mb-8 overflow-hidden bg-white rounded-lg shadow-lg">
                        ...
                        <div class="w-full overflow-x-auto">
                            ...
                            <div class="m-2 p-2" v-if="episodes.data.lenght">
...
<script setup>
    ...
    watch(search,value => {
        Inertia.get('/admin/tv-shows/'+props.tvShow.id+'/seasons/'+props.season.id+'/episodes', { search: value,perPage: perPage.value },{
            preserveState: true,
            replace: true
        });
    })
    ...
    function getEpisodes(){
        Inertia.get('/admin/tv-shows/'+props.tvShow.id+'/seasons/'+props.season.id+'/episodes', { perPage: perPage.value,search: search.value },{
            preserveState: true,
            replace: true
        });
    }
